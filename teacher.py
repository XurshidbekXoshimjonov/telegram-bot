...
@teacher_router.message(F.text == "Ustoz kerak")
...
@teacher_router.message(Form.ism_familiya)
...
@teacher_router.message(Form.yosh)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.texnolog)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.aloqa)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.hudud)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.Narx)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.Kasb)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.murojaat)
async def  f1(message: Message, state: FSMContext):
...
@teacher_router.message(Form.Maqsad)
async def  f1(message: Message, state: FSMContext):
